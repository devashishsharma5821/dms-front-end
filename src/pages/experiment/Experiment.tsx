...
import { TransformersAppStoreState } from '../../models/transformer';
...
const ExperimentsPage = () => {
    ...
    useEffect(() => {
        if(TransformersData === null) {
            ...
            console.log('TransformersData', TransformersData)
            let transformerData = TransformersData;
