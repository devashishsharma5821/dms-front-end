...
export type InferredOutput =
    | { kind: InputOutputType.Dataframe, spec: DataframeSpec }
    | { kind: InputOutputType.Dataset, spec: DatasetSpec }
    | { kind: InputOutputType.Model, spec: ModelSpec }
