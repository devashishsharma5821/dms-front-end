...
import { Box, Flex, Divider, useColorModeValue, Center, VStack, Square,  Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, useDisclosure, Button, FormControl, FormLabel, Input, Select, Switch, Text, Tooltip } from '@chakra-ui/react';
    ...
    return (
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered>
        ...
        <ModalContent width={630} maxWidth={630} height="var(--chakra-space-464)" color="#171717">
          <ModalHeader height="var(--chakra-space-60)" fontSize={16} borderBottom="1px solid #EAEAEA" fontWeight="700" flex={'none'} padding={20}>Edit Compute</ModalHeader>
          <ModalCloseButton mt={10}/>
          <ModalBody padding={20}>
           <FormControl>
                <FormLabel>Compute Name <Text as='sup' color='#ED1C24' fontSize={16} fontWeight="bold" verticalAlign={'sub'}>*</Text></FormLabel>
                <Input type='text' />
                
            </FormControl>
            <Box mt={22} display="flex" mb={20}>
            <FormControl width={327}>
                <FormLabel>Worker Type <Text as='sup' color='#ED1C24' fontSize={16} fontWeight="bold" verticalAlign={'sub'}>*</Text><Tooltip label='Right end' placement='right-end' hasArrow ><Text display={'inline-block'} ml={2}><InfoIcon /></Text></Tooltip></FormLabel>
                <Select placeholder='Standard_DS3_v2   56 GB | 16 Cores' icon={<Text mt={10} marginRight={'13'}><BlackbottomedTriangleIcon/></Text> }>
                    <option>Standard_DS3_v2   56 GB | 16 Cores </option>
                </Select>
            </FormControl>
            <FormControl width={112} ml={24} >
                <FormLabel>Min Workers<Text as='sup' color='#ED1C24' fontSize={16} fontWeight="bold" verticalAlign={'sub'}>*</Text></FormLabel>
                <Input type='text' />
                
            </FormControl>
            <FormControl width={113} ml={16}>
                <FormLabel>Max Workers<Text as='sup' color='#ED1C24' fontSize={16} fontWeight="bold" verticalAlign={'sub'}>*</Text></FormLabel>
                <Input type='text' />
          ...
          <ModalFooter height="var(--chakra-space-75)" borderTop="1px solid #EAEAEA" padding={'20'}>
            ...
            <Button colorScheme='blue' fontSize={16}  ml={15} pt={'10'} pb={'10'} pl={'17'} pr={'17'}>Create</Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
            </div>
