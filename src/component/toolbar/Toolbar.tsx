                                        ...
                                        {sections.type === 'downArrow' && (
                                            <>
                                                ...
                                                >
                                                    ...
                                                    <PopoverContent>
                                                        <PopoverBody mt={'5px'}>
                                                            { props.computeData.length !== 0 && props.computeData.map((compute: any) => {
                                                                    return (
                                                                        <Flex pb={'10px'} justifyContent={'space-between'}>
                                                                            <Center>
                                                                                {
                                                                                    (compute.active) ? <Box mr={'8'}> <DeployedIcon /></Box> : <Box mr={'8'}><DeployedNotRunningIcon /></Box>
                                                                                }
                                                                                <Box fontWeight={'600'} fontSize={'16px'} color={textColor}>{compute.name}</Box>
                                                                            </Center>
                                                                            <Center fontWeight="medium" fontSize="sm" color={'default.containerAgGridRecords'}>
